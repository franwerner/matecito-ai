...
func (_c *ChangeCreate) SetCreatedAt(v string) *ChangeCreate {
	_c.mutation.SetCreatedAt(v)
	return _c
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_c *ChangeCreate) SetNillableCreatedAt(v *string) *ChangeCreate {
	if v != nil {
		_c.SetCreatedAt(*v)
	}
	return _c
...
func (_c *ChangeCreate) SetUpdatedAt(v string) *ChangeCreate {
	_c.mutation.SetUpdatedAt(v)
	return _c
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_c *ChangeCreate) SetNillableUpdatedAt(v *string) *ChangeCreate {
	if v != nil {
		_c.SetUpdatedAt(*v)
	}
	return _c
...
func (_c *ChangeCreate) SetProjectID(v string) *ChangeCreate {
	_c.mutation.SetProjectID(v)
	return _c
}

// SetBranch sets the "branch" field.
func (_c *ChangeCreate) SetBranch(v string) *ChangeCreate {
	_c.mutation.SetBranch(v)
	return _c
}

// SetName sets the "name" field.
func (_c *ChangeCreate) SetName(v string) *ChangeCreate {
...
func (_c *ChangeCreate) SetID(v string) *ChangeCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ChangeCreate) SetNillableID(v *string) *ChangeCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ChangeCreate) SetProject(v *Project) *ChangeCreate {
...
func (_c *ChangeCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if change.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized change.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := change.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if change.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized change.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if change.DefaultID == nil {
			return fmt.Errorf("ent: uninitialized change.DefaultID (forgotten import ent/runtime?)")
		}
		v := change.DefaultID()
		_c.mutation.SetID(v)
	}
...
func (_c *ChangeCreate) check() error {
	...
	if _, ok := _c.mutation.ProjectID(); !ok {
		return &ValidationError{Name: "project_id", err: errors.New(`ent: missing required field "Change.project_id"`)}
	}
	if _, ok := _c.mutation.Branch(); !ok {
		return &ValidationError{Name: "branch", err: errors.New(`ent: missing required field "Change.branch"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Change.name"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "Change.status"`)}
	}
	if len(_c.mutation.ProjectIDs()) == 0 {
		return &ValidationError{Name: "project", err: errors.New(`ent: missing required edge "Change.project"`)}
	}
	return nil
}
...
func (_c *ChangeCreate) sqlSave(ctx context.Context) (*Change, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected Change.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *ChangeCreate) createSpec() (*Change, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(change.Table, sqlgraph.NewFieldSpec(change.FieldID, field.TypeString))
	)
	...
	if value, ok := _c.mutation.CreatedAt(); ok {
		_spec.SetField(change.FieldCreatedAt, field.TypeString, value)
