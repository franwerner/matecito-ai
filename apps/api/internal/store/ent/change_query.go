...
func (_q *ChangeQuery) QueryProject() *ProjectQuery {
...
func (_q *ChangeQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChangeQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ChangeQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ChangeQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ChangeQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ChangeQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChangeQuery) WithProject(opts ...func(*ProjectQuery)) *ChangeQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
func (_q *ChangeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Change, error) {
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *Change, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ChangeQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Change, init func(*Change), assign func(*Change, *Project)) error {
...
func (_q *ChangeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(change.Table, change.Columns, sqlgraph.NewFieldSpec(change.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(change.FieldProjectID)
		}
	}
