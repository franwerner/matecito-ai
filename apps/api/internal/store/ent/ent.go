...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			contentobject.Table:     contentobject.ValidColumn,
			event.Table:             event.ValidColumn,
			eventrecordpin.Table:    eventrecordpin.ValidColumn,
			iterationnote.Table:     iterationnote.ValidColumn,
			project.Table:           project.ValidColumn,
			projectpath.Table:       projectpath.ValidColumn,
			record.Table:            record.ValidColumn,
			recordbranchstate.Table: recordbranchstate.ValidColumn,
			recordversion.Table:     recordversion.ValidColumn,
			recordversionref.Table:  recordversionref.ValidColumn,
		})
	})
