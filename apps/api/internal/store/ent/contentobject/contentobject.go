...
const (
	// Label holds the string label denoting the contentobject type in the database.
	Label = "content_object"
	...
	EdgeProject = "project"
	// Table holds the table name of the contentobject in the database.
	Table = "content_objects"
	// ProjectTable is the table that holds the project relation/edge.
	ProjectTable = "content_objects"
...
// Columns holds all SQL columns for contentobject fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ContentObject queries.
