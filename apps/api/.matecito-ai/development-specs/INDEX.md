...
|---|---|---|
| `flow` | Operaciones de cara a un actor, con pasos y ramas (submit de fase, iniciar change) | [flow/INDEX.md](flow/INDEX.md) |
| `rule` | Reglas de negocio transversales, sin flujo (scoping de eventos, políticas) | [rule/INDEX.md](rule/INDEX.md) |
| `lifecycle` | Máquinas de estado de una entidad (su ciclo de vida y transiciones) | [lifecycle/INDEX.md](lifecycle/INDEX.md) |
| `process` | Comportamiento reactivo/de fondo, disparado por evento o por el sistema (file-watch, indexado, versionado) | [process/INDEX.md](process/INDEX.md) |
