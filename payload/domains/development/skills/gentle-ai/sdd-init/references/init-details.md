...
sdd-init no construye ningún registry. Cada fase SDD carga su propia `SKILL.md`. Las convenciones del proyecto se leen directamente de sus archivos: `.matecito-ai/edr/` (decisiones de arquitectura), `CLAUDE.md`, y `config.yaml`.
