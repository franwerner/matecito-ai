...
> **This is a consultable catalog, not a skill.** The `project-decisions-bootstrap` and `sdd-design` skills reference it by pattern name. When an ADR declares `Patrón aplicado: X`, the canonical definition lives in [`patterns/<x>.md`](patterns/).
