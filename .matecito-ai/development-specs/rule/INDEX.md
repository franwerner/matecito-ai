...
| `mailbox-item-summary-rationale-split` | Items en secciones buzón llevan un split opt-in: `summary` se imprime en el gate, `rationale` se emite siempre en el mismo bloque | Accepted | [`mailbox-item-summary-rationale-split.md`](mailbox-item-summary-rationale-split.md) |
