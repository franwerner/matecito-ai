...
| `gate-firing-triggers` | Cuándo un gate detiene el flujo, decidido por dos triggers (contested finding, contract shape), nunca por la sección; qué llega al usuario cuando no dispara | Accepted | [`gate-firing-triggers.md`](gate-firing-triggers.md) |
...
| `intake-brief-components-line` | Línea `Components` en el Intake Brief: clasificación por-cambio de superficies del repo tocadas, con gate presence-based; decidida por `sdd-intake` y reportada, nunca ratificada | Accepted | [`intake-brief-components-line.md`](intake-brief-components-line.md) |
