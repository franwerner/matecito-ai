...
- Las **vías de ratificación son enumeradas y disjuntas**, y cada una ratifica su propia proyección y ninguna otra: (a) el **set del repo** — una sola vez, editable, al declararlo; (b) los **componentes de un spec** — spec por spec, al autorizarlo o minarlo; (c) el **valor por-cambio** — una sola vez por cambio, por `sdd-intake` y reportado.
