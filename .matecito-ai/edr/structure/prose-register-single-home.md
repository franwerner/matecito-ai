...
## Contexto
La instrucción de cómo redactar un ítem de buzón gate-facing o un resumen ejecutivo podía terminar copiada en cada uno de los seis contratos de retorno que declaran el split summary/rationale, con el riesgo de desincronizarse en la próxima edición — el mismo patrón de duplicación que ya forzó a centralizar el contrato de retorno completo en una única sección.
...
## Reglas verificables
- **[manual]** Los seis contratos de retorno que declaran el split summary/rationale contienen un puntero a la sección compartida, no una copia del criterio de registro.
- **[manual]** El protocolo compartido de fases es el único lugar donde el criterio de registro está escrito en extenso.

## Alternativas consideradas
Copiar la instrucción en cada uno de los seis contratos. Descartado: reproduce el mismo patrón de duplicación que la centralización del contrato de retorno ya existe para evitar — la próxima edición del criterio desincroniza seis copias en vez de una.
